 /* --------------------------------------------------
  * © Copyright 2022 - Kementrian Kelautan dan Perikanan
  * --------------------------------------------------*/
(function($) {
	'use strict';
    ...
    if($("body").hasClass("switch-scheme")){
     ...
     jQuery("#dark-mode").on("click", function() {
        if(jQuery('body').hasClass('dark-scheme')){
            window.location.href = 'https://gigaland.io/home.html';
        }else{
            window.location.href = 'https://gigaland.io/02_dark-home.html';
        }
     });
