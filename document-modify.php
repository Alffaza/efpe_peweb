                        ...
                        <form id="form-create-item" class="form-border" method="post" action="src/process/modif_biodata.php" enctype="multipart/form-data">
                            ...
                            <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="male" name="jenis_kelamin">Male
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="female" name="jenis_kelamin">Female
                                    </label>
                                </div>
                                ...
                                <!-- <div id="kualifikasi_pendidikan" class="dropdown fullwidth mb20">
                                    <a href="#" class="btn-selector">Kualifikasi Pendidikan</a>
                                    <ul>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="SD" name="kualifikasi_pendidikan">SD
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="SMP" name="kualifikasi_pendidikan">SMP
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="SMA" name="kualifikasi_pendidikan">SMA
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="D3" name="kualifikasi_pendidikan">D3
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="S1" name="kualifikasi_pendidikan">S1
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="S2" name="kualifikasi_pendidikan">S2
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="S3" name="kualifikasi_pendidikan">S3
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" value="Lainnya" name="kualifikasi_pendidikan">Lainnya
                                    </label>
                                </div>
                                <div style="margin:1rem"></div>
                                ...
                                <div id="item_collection" class="dropdown fullwidth mb20">
                                    ...
                                    <div class="d-create-file">
                                        ...
                                        <input type="file" name="foto_berkas">
                                    </div>
                                    ...
                                    <input type="submit" id="submit" class="btn-main" value="Upload">
